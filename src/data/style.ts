...
export const styleList: GameStyle[] = [
  // --- 适合小游戏的风格优先 (ID 1-30) ---
  { id: 1, name: "粘土风格", example: "《小鸡舰队出击》", features: "模拟手工捏制，软萌充气感，指纹肌理，亲和力极佳。", img: "ntfg.png", type: [1, 2] },
  { id: 2, name: "Q版果冻风", example: "《Candy Crush Saga》", features: "高光极亮，半透明Q弹，甜美饱和，极易吸引点击。", img: "qbgdf.png", type: [1, 4] },
  ...
  { id: 7, name: "卡纸拼贴", example: "《纸片马里奥》", features: "多层纸张剪裁叠加，边缘投影物理深度，手工制作感，温馨童趣。", img: "kzpt.png", type: [1, 2] },
  { id: 8, name: "涂鸦风", example: "《Doodle Jump》", features: "手绘草稿感，不规则边缘，随意线条，亲和力极强。", img: "tyf.png", type: [1] },
  ...
  { id: 12, name: "故障艺术", example: "《超阈限空间》", features: "画面撕裂，色偏，数字信号中断感，前卫且不安。", img: "gzys.png", type: [1, 2] },
  { id: 13, name: "怀旧牛皮纸", example: "《饥荒》", features: "羊皮纸纹理，手绘线条，泛黄做旧，生存解谜感。", img: "hjnpz.png", type: [1, 2, 5] },
  { id: 14, name: "水墨画风", example: "《影之刃 3》", features: "墨迹渲染，留白艺术，飞白笔触，中式意境。", img: "smhf.png", type: [1, 2, 4] },
  { id: 15, name: "剪纸风格", example: "《纸嫁衣》", features: "典型红白对比，民俗图案，平面层级感，独特文化感。", img: "jzfg.png", type: [1, 2] },
  { id: 16, name: "科幻全息", example: "《质量效应》", features: "蓝光半透明叠加，扫描线，流光轨迹，未来信息屏。", img: "khqx.png", type: [1, 3, 5] },
  { id: 17, name: "软糖风格", example: "《糖豆人》", features: "半透明软糯感，鲜艳配色，弹性十足的视觉效果。", img: "rtfg.png", type: [1, 5] },
  { id: 18, name: "低多边形", example: "《明日之后》", features: "明显三角面构成，硬朗切割感，现代艺术感。", img: "ddbx.png", type: [1, 2, 4] },
  ...
  { id: 21, name: "北欧风", example: "《奥托的历险》", features: "冰冷干净，功能主义，冷色调，极简自然美。", img: "bef.png", type: [1, 2] },
  { id: 22, name: "美式卡通", example: "《部落冲突》", features: "夸张比例，流线型设计，明艳快节奏视觉。", img: "mskt.png", type: [1, 4, 5] },
  { id: 23, name: "荒诞搞怪", example: "《人类一败涂地》", features: "扭曲形状，滑稽表情，不规则色彩，幽默感。", img: "hdgg.png", type: [1, 2, 5] },
  { id: 24, name: "魔法书风格", example: "《哈利波特：魔法觉醒》", features: "符文封印，羊皮纸卷轴，神秘金边，古老咒语感。", img: "mfsfg.png", type: [1, 4, 5] },
  { id: 25, name: "农场牧场", example: "《卡通农场》", features: "栅栏奶牛纹，草地绿，温暖阳光，田园牧歌感。", img: "ncmc.png", type: [1, 4] },
  { id: 26, name: "电子竞技", example: "《无畏契约》", features: "侵略性斜线，金属拉丝，荧光强调色，极速竞技感。", img: "dzjj.png", type: [1, 5] },
  { id: 27, name: "治愈系插画", example: "《光·遇》", features: "温暖手绘，模糊边缘，柔光滤镜，情感共鸣感。", img: "zyxch.png", type: [1, 2, 5] },
  { id: 28, name: "微缩景观风", example: "《Tiny Room》", features: "移轴摄影视效，模型质感 UI，强烈的景深效果。", img: "wxjgf.png", type: [1, 2] },
  { id: 29, name: "黑金奢华感", example: "《黄金投资小游戏》", features: "深哑光黑底，哑金线条，大理石纹路。商务且高级。", img: "hjshg.png", type: [1, 4] },
  { id: 30, name: "动态贴纸风", example: "《手账小游戏》", features: "白边贴纸感，动态摇晃动效，拼贴画构图。", img: "dttzf.png", type: [1, 2] },
  ...
  { id: 46, name: "复古海报风", example: "《辐射4》", features: "50-60年代质感，做旧纸张，复古印刷色。", img: "fghbf.png", type: [2, 3] },
  ...
  { id: 49, name: "暗黑模式", example: "《无畏契约》", features: "深色基调，高对比色彩强调，沉浸感。", img: "ahms.png", type: [5] },
  { id: 50, name: "16-Bit 像素", example: "《星露谷物语》", features: "丰富色彩层次，细腻像素笔触，精致怀旧。", img: "16-Bitxs.png", type: [2, 5] },
  { id: 51, name: "等距像素", example: "《Habbo Hotel》", features: "45度斜角透视，块状堆叠，整齐有序。", img: "djxs.png", type: [1, 4] },
  { id: 52, name: "GameBoy 绿质感", example: "《宝可梦初代》", features: "限定四种绿色色阶，复古单色屏幕感。", img: "gbjzg.png", type: [1, 2] },
  { id: 53, name: "街机风格", example: "《吃豆人》", features: "霓虹闪烁，黑底高亮，快节奏视觉符号。", img: "jjfg.png", type: [1] },
  { id: 54, name: "CRT 模拟风", example: "《茶杯头》", features: "扫描线，屏幕畸变，噪点滤镜，老式显像管视觉。", img: "crtmnf.png", type: [2] },
  { id: 55, name: "蒸汽波", example: "《Data Wing》", features: "粉紫夕阳，石膏像，梦幻忧郁，90年代电子感。", img: "zqw.png", type: [1, 2] },
  { id: 56, name: "黑胶唱片风", example: "《Muse Dash》", features: "模拟胶片机、唱片封套质感，复古印刷质感。", img: "hjcpf.png", type: [1, 2] },
  { id: 57, name: "维多利亚风", example: "《福尔摩斯：罪与罚》", features: "华丽花边，衬线体，古典贵族气息。", img: "wdlyf.png", type: [2, 3] },
  { id: 58, name: "哥特风格", example: "《恶魔城》", features: "黑暗，尖锐，神秘，冷峻庄严。", img: "gtfg.png", type: [2] },
  { id: 59, name: "洛可可风", example: "《爱丽丝：疯狂回归》", features: "极尽繁琐，金边卷草纹，曲线优美，极度华丽。", img: "lkkf.png", type: [2, 3] },
  { id: 60, name: "古典油画风", example: "《昆特牌UI》", features: "模拟布面油画，可见笔触，厚重深沉。", img: "gdyhf.png", type: [2, 4] },
  { id: 61, name: "蓝图设计", example: "《模拟城市4》", features: "蓝底白线，工程制图感，精密逻辑。", img: "ltsj.png", type: [1, 2] },
  ...
  { id: 89, name: "厚涂重彩", example: "《万国觉醒》", features: "油画笔触，史诗感，画面庄重。", img: "htzc.png", type: [4, 5] },
  ...
  { id: 93, name: "废土风格", example: "《辐射避难所》", features: "铁锈破损，资源匮乏的工业废料感。", img: "ftfg.png", type: [1, 2, 4] },
  { id: 94, name: "太空歌剧", example: "《星际迷航》", features: "宏大星系背景，流线飞船UI。", img: "tkgy.png", type: [3, 4, 5] },
  { id: 95, name: "丛林探险", example: "《神庙逃亡》", features: "藤蔓树叶，木牌指示，自然原始质感。", img: "zltx.png", type: [1] },
  { id: 96, name: "海洋水族", example: "《深海迷航》", features: "气泡波光，清透深蓝，流动感。", img: "hyxz.png", type: [2, 3, 5] },
  { id: 97, name: "糖果屋风格", example: "《Candy Town》", features: "甜甜圈棒棒糖元素，童话气息。", img: "tgwfg.png", type: [1] },
  { id: 98, name: "玩具工厂", example: "《满意工厂》", features: "螺丝传送带，亮色工业塑料。", img: "wjgc.png", type: [2, 5] },
  { id: 99, name: "侦探解谜", example: "《黑色洛城》", features: "百叶窗阴影，黑白对比，悬疑氛围。", img: "dtjm.png", type: [2, 3] },
  { id: 100, name: "恐怖惊悚", example: "《生化危机8》", features: "血迹斑驳，忽明忽暗，压迫不安感。", img: "kbjs.png", type: [2, 3] },
  { id: 101, name: "圣诞主题", example: "《守望先锋冬季UI》", features: "红绿金配色，铃铛，温馨节日视觉。", img: "sdzt.png", type: [5] },
  { id: 102, name: "波西米亚", example: "《Gris》", features: "流苏几何图腾，自由浪漫不羁感。", img: "bxmy.png", type: [2] },
  { id: 103, name: "硬核军事", example: "《使命召唤》", features: "迷彩数值，夜视仪色调，精密网格。", img: "hljs.png", type: [3, 5] },
  { id: 104, name: "AI 幻觉风", example: "《The Artful Escape》", features: "多重质感融合，流动变形，不可名状之美。", img: "aihjf.png", type: [2, 3] }
];